  ...
  tf_listener_(tf_buffer_)
{
  ...
  const auto tmp = static_cast<std::vector<int64_t>>(this->declare_parameter("can_assign_matrix").get<std::vector<int64_t>>());
  const std::vector<int> can_assign_matrix(tmp.begin(), tmp.end());

  const auto max_dist_matrix = static_cast<std::vector<double>>(this->declare_parameter("max_dist_matrix").get<std::vector<double>>());
  ...
  const auto max_rad_matrix = static_cast<std::vector<double>>(this->declare_parameter("max_rad_matrix").get<std::vector<double>>());
  const auto min_iou_matrix = static_cast<std::vector<double>>(this->declare_parameter("min_iou_matrix").get<std::vector<double>>());

  // tracker map
  tracker_map_.insert(
    std::make_pair(Label::CAR, static_cast<std::string>(this->declare_parameter("car_tracker").get<std::string>())));
  tracker_map_.insert(
    std::make_pair(Label::TRUCK, static_cast<std::string>(this->declare_parameter("truck_tracker").get<std::string>())));
  tracker_map_.insert(
    std::make_pair(Label::BUS, static_cast<std::string>(this->declare_parameter("bus_tracker").get<std::string>())));
  tracker_map_.insert(
    std::make_pair(Label::TRAILER, static_cast<std::string>(this->declare_parameter("trailer_tracker").get<std::string>())));
  tracker_map_.insert(
    std::make_pair(Label::PEDESTRIAN, static_cast<std::string>(this->declare_parameter("pedestrian_tracker").get<std::string>())));
  tracker_map_.insert(
    std::make_pair(Label::BICYCLE, static_cast<std::string>(this->declare_parameter("bicycle_tracker").get<std::string>())));
  tracker_map_.insert(
    std::make_pair(Label::MOTORCYCLE, static_cast<std::string>(this->declare_parameter("motorcycle_tracker").get<std::string>())));
