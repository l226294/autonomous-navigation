...
: Node("lidar_center_point", node_options), tf_buffer_(this->get_clock())
{
  ...
  const auto pcd_path = static_cast<std::string>(this->declare_parameter("pcd_path").get<std::string>());
  const auto detections_path = static_cast<std::string>(this->declare_parameter("detections_path").get<std::string>());
