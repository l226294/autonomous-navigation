...
class ActorFactory(object):
    ...
    def spawn_actor(self, req, enable=False):
        """
        spawns an object
        ...
        with self.spawn_lock:
            if "pseudo" in req.type:
                ...
                id_ = self._spawn_carla_actor(req, enable)
    ...
    def _spawn_carla_actor(self, req, enable=False):
        """
        ...
        if "*" in req.type:
            ...
            while enable:                
                if blueprint.id.endswith('firetruck') or blueprint.id.endswith('ambulance') \
