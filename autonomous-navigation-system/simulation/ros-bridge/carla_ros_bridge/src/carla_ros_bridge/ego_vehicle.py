...
from autoware_auto_vehicle_msgs.msg import VehicleOdometry
...
class EgoVehicle(Vehicle):
    ...
    def __init__(self, uid, name, parent, node, carla_actor, vehicle_control_applied_callback):
        ...
        self.vehicle_odometry_publisher = node.new_publisher(
            VehicleOdometry,
            self.get_topic_prefix() + "/front_wheel_angle",
            qos_profile=10)
    ...
    def send_vehicle_msgs(self, frame, timestamp):
        ...
        vehicle_odometry.stamp = vehicle_status.header.stamp
        vehicle_odometry.velocity_mps = self.get_vehicle_speed_abs(self.carla_actor)
        vehicle_odometry.front_wheel_angle_rad = self.carla_actor.get_control().steer * max_steer_angle / 180 * math.pi 
        vehicle_odometry.rear_wheel_angle_rad = 0.0
    ...
    def enable_autopilot_updated(self, enable_auto_pilot):
        ...
        self.carla_actor.set_autopilot(enable_auto_pilot.data, 8000)
