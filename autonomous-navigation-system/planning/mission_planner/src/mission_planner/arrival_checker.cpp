...
{
  const double angle_deg = static_cast<double>(node->declare_parameter("arrival_check_angle_deg").get<double>());
  angle_ = tier4_autoware_utils::deg2rad(angle_deg);
  distance_ = static_cast<double>(node->declare_parameter("arrival_check_distance").get<double>());
  duration_ = static_cast<double>(node->declare_parameter("arrival_check_duration").get<double>());
