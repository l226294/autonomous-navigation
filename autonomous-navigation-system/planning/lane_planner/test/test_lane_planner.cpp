...
using autoware::common::types::bool;
using autoware::common::types::float;
using autoware::common::types::double;
...
HADMapRoute getARoute(const int64_t lane_id, const float length)
{
